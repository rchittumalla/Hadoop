...
spark = SparkSession.builder.appName("StructuredNetworkWordCountWindowOperation").getOrCreate()
...
windowedCounts = words.groupBy(window(words.timestamp, "1 minutes"),words.word).count()
